...
-(void)testPlacesWithCoordinatesURL {
    double latitude = 52.3547;
    double longitude = 4.8339;
    NSString *urlString = [NSString stringWithFormat:@"wikipedia://places?lat=%f&lon=%f", latitude, longitude];
